...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_movie'])) {
        ...
        if ($conn->query($sql) === TRUE) {
            $message = "<div class='alert alert-success'>New movie added successfully!</div>";
        } else {
    ...
    elseif (isset($_POST['update_movie'])) {
        ...
        if ($conn->query($sql) === TRUE) {
            $message = "<div class='alert alert-success'>Movie updated successfully!</div>";
        } else {
            $message = "<div class='alert alert-danger'>Error: " . $sql . "<br>" . $conn->error . "</div>";
        }
    }
    ...
    elseif (isset($_POST['delete_movie'])) {
        ...
        if ($conn->query($sql) === TRUE) {
            $message = "<div class='alert alert-success'>Movie deleted successfully!</div>";
        } else {
            $message = "<div class='alert alert-danger'>Error: " . $sql . "<br>" . $conn->error . "</div>";
        }
    }
